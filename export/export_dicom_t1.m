...
for dynamic = 1:dimd
    ...
    for slice = 1:dimz
        ...
        fname = [directory,filesep,'T1map-DICOM-',tag,filesep,'T1map-slice',fn,'-dynamic',dn,'.dcm'];
...
for dynamic = 1:dimd
    ...
    for slice=1:dimz
        ...
        fname = [directory,filesep,'T1map-DICOM-',tag,filesep,'M0map-slice',fn,'-dynamic',dn,'.dcm'];
...
for dynamic = 1:dimd
    ...
    for slice=1:dimz
        ...
        fname = [directory,filesep,'T1map-DICOM-',tag,filesep,'R2map-slice',fn,'-dynamic',dn,'.dcm'];
